...
export default class SocialNetworkingAPI extends Component {
    componentDidMount(){
        window.scrollTo(0, 0);}
    render() {
        return (
...
<MDBCol>
<MDBAnimation type="fadeInUp">
<img src={require('../images/social-api.png')} alt=""/>
</MDBAnimation>
</MDBCol>
...
<MDBContainer>
    <h2 className="is-h4 mb-5 text-center">Social Networking APIs</h2>
    <MDBRow>
<MDBCol md="4">
<MDBAnimation reveal type="fadeInUp">
    <div className="apis">
