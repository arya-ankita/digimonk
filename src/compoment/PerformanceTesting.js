...
export default class PerformanceTesting extends Component {
    render() {
        return (
          <>
            <Navbar />
            <InnerBannerTop
              breadcrumbname="Home"
              breadcrumactive="Performance Testing"
              ...
              <MDBContainer>
                <MDBRow className="d-flex align-items-center">
                  ...
                  <MDBCol>
                    <MDBAnimation type="fadeInUp">
                      <img
                        src={require("../images/performance_about_screen.png")}
                        alt=""
                      />
                    </MDBAnimation>
                  </MDBCol>
              ...
              <MDBContainer>
                <MDBRow className="d-flex align-items-center">
                  ...
                  <MDBCol md="6">
                    <MDBAnimation reveal type="fadeInUp">
                      <img
                        src={require("../images/performance_wt_screen.png")}
                        alt=""
                      />
                    </MDBAnimation>
                  </MDBCol>
