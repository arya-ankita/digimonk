...
export default class Drupal extends Component {
    render() {
        return (
            <div>
                <Navbar/>
...
Development</h2>
                ...
                <MDBAnimation type="fadeInUp">
                <p>
                From professional blogs to enterprise apps & community forums to eCommerce stores, we can shape successful businesses with Drupal.
...
<MDBCol>
<MDBAnimation type="fadeInUp">
<img src={require('../images/drupal-banner-right.png')} alt=""/>
</MDBAnimation>
</MDBCol>
...
<MDBCol md="6" className="text-center">
    <MDBAnimation reveal type="fadeInUp">
        <img src={require('../images/Drupal.png')} alt=""/>
        </MDBAnimation>  
    </MDBCol>
    <MDBCol md="6">
    <MDBAnimation reveal type="fadeInUp">
    <h2>Get A Business Accelerant With
Drupal Development Services</h2>
    <p>Feature rich application development with is extendable and optimized for SEO is complex to make. At TIS India, we make this task look easy with our versatility on multiple Drupal services. Get total security and immense functionality with Drupal solutions</p>
<div className="word">
<ul className="digimonk-list">
					<li>
				
					
					<h3>Secure and robust</h3>
...
<section>
    <MDBContainer>
    <MDBAnimation reveal type="fadeInUp">
    <h2 className="mb-3">Drupal Ecommerce
...
<section className="gray">
    ...
    <MDBRow>
        <MDBCol md="6">
        <MDBAnimation reveal type="fadeInUp">
            <img src={require('../images/drupal-brands-left.jpg')} alt=""/>
            </MDBAnimation>
        </MDBCol>
        <MDBCol md="6">
        <MDBAnimation reveal type="fadeInUp">
        <h2 className="mb-3">Drupal Development made smart, scalable, and flexible with Digimonk</h2>
        <p>We offer a complete suite of value-added WordPress services that set us apart in terms of quality, performance, and value. Right from a small static website to a comprehensive e-commerce portal, we can do it all.</p>
            <h3 className="mb-3">Why choose us for Drupal Website Development?</h3>
            <ul className="digimonk-list">
...
<section>
    <MDBContainer>
    <MDBAnimation reveal type="fadeInUp">
    <h2 className="mb-3">Reasons To Choose Drupal Web Development Services For Success</h2>
    </MDBAnimation>
